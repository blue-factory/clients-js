...
class Authentication {
    ...
    verifyToken(token) {
        ...
        return promisify_1.default(this.client, 'verifyToken')({ token });
    }
    login(email, password) {
        ...
        return promisify_1.default(this.client, 'login')({ email, password });
    }
    signUp(user) {
        if (user === undefined) {
        ...
        return promisify_1.default(this.client, 'signUp')({ user });
    }
}
